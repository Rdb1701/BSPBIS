...
WHERE sp.on_status = 0 and sp.status = 1 and cash.status = 1
...
foreach($parents as $key => $value){
    ...
    <button class = 'btn btn-success' title='Restore' onclick= 'restore_cash(".$value['cash_id'].")'><i class = 'fa fa-recycle'></i></button>&nbsp;
   <button class = 'btn btn-danger' title='Permanently Delete' onclick= 'delete_cash(".$value['cash_id'].")'><i class = 'fa fa-trash-alt'></i></button>
    </div>
  </td>
    ";
