...
foreach($parents as $key => $value){
   ...
   <button class = 'btn btn-danger' onclick= 'delete_parent(".$value['parent_id'].")'><i class = 'fa fa-trash'></i></button>
    ...
    ";
    $data['data'][] = array($value['fname'], $value['mname'],$value['lname'],$value['bday'] ,$value['age'], $value['gender'],$value['barangay'],$value['control_no'],$value['date_inserted'],$value['status'],$descendants_button,$button);
  }
