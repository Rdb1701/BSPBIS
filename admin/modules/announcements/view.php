...
$query = "
SELECT activity_desc, purpose, activity_id, DATE(date_inserted) as date_insert
...
if ($numRows > 0) {
  ...
  foreach($announcement as $key => $value){
   ...
   <button class = 'btn btn-danger' onclick= 'delete_activity(".$value['activity_id'].")'><i class = 'fa fa-trash'></i></button>
    ...
    ";
    $data['data'][] = array($value['activity_desc'], $value['purpose'],$value['date_inserted'],$button);
  }
